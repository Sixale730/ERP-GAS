...
import { Button, Card, Col, Form, Input, Row, Select, Tag, Typography, message, Space } from 'antd'
import {
  FileTextOutlined,
  InboxOutlined,
        ...
        <Row gutter={[24, 24]}>
          {features.map((f, i) => (
            <Col xs={24} sm={12} lg={6} key={i}>
              <Card
                hoverable
                style={{ height: '100%', textAlign: 'center', borderRadius: 12, border: '1px solid #f0f0f0', background: '#fff' }}
