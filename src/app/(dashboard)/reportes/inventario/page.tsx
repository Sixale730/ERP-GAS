...
export default function ReporteInventarioPage() {
  ...
  const columns: ColumnsType<InventarioRow> = useMemo(() => [
    ...
    },
    {
      ...
      width: 110,
      align: 'right',
      render: (val: number) => val > 0 ? <Text style={{ color: '#1890ff' }}>{val}</Text> : <Text type="secondary">0</Text>,
    },
    {
      title: 'Min / Max',
      key: 'min_max',
  ...
  const handleDescargarPDF = async () => {
    ...
    try {
      ...
      await generarPDFReporte({
        ...
        columnas: [
          { titulo: 'SKU', dataIndex: 'sku', width: 90 },
          { titulo: 'Producto', dataIndex: 'producto_nombre' },
          { titulo: 'Almacen', dataIndex: 'almacen_nombre', width: 120 },
          { titulo: 'Total en físico', dataIndex: 'cantidad', width: 80, halign: 'right' },
          { titulo: 'Reservado', dataIndex: 'cantidad_reservada', width: 75, halign: 'right' },
          { titulo: 'Disp. venta', dataIndex: 'disponible', width: 80, halign: 'right' },
          { titulo: 'En tránsito', dataIndex: 'en_transito', width: 80, halign: 'right' },
          { titulo: 'Min / Max', dataIndex: 'min_max', width: 85, halign: 'center' },
          { titulo: 'Nivel', dataIndex: 'nivel_stock', width: 75, halign: 'center' },
        ],
