...
import {
  Card, Form, Select, Button, Table, InputNumber, Input, Space, Typography, message, Divider, Row, Col, AutoComplete, Tooltip, Spin, Collapse, Segmented
} from 'antd'
...
export default function EditarCotizacionPage() {
  ...
  ], [handleUpdateItem, handleRemoveItem, idsSinStock, inventarioMap])
